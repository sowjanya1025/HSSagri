...
$data = "This content is generated by PHP.";
?>
<!doctype html>
<html lang="en">
  ...
  <?php
	...
	?>
	  ...
	  <?php 
	    ...
	    <td><input type="button" class="printbtn" id1="<?php echo htmlspecialchars($cdata['farmers_name']); ?>" id2="<?php echo htmlspecialchars($cdata['item_code']); ?>" id3="<?php echo htmlspecialchars($cdata['quantity']); ?>" id4="<?php echo htmlspecialchars($cdata['price']); ?>" id5="<?php echo htmlspecialchars($cdata['totamt']); ?>"  name="print" <?php echo $state; ?> value="print"  ></td>
    </tr>
	<?php }
  ?>
  </tbody>
