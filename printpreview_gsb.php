...
$itemdata = $account->getGoods_SupplyBillByID($accountId,$pid);
	   ...
	   $clientType = $itemdata['client_type'];
	   switch ($clientType) {
        case '1':
            $list = "modern";
            break;
...
<body>
  ...
  <tbody>
    <tr>
      ...
      <td width="50%"><strong>Client Type :</strong><?php echo $list; ?><br><strong>Client Name:</strong> <?php echo htmlspecialchars($itemdata['clients_name']); ?>(<?php echo htmlspecialchars($itemdata['clcode']); ?>)<br></td>
    </tr>
    <tr>
