...
class account extends db_connect
{
	...
	public function setfarmer_Onboarding($fname,$contact,$email,$pan,$adhar,$newfilename,$kycFilesSerialized,$acctid)
	{
		$result = '';
		...
		$stmt=$this->db->prepare("INSERT INTO `farmer_onboarding`(user_id,`fr_name`,`fr_code` , `fr_contact`, `fr_email`, `fr_pan`, `fr_adhar`, `fr_image`,`fr_kyc`) VALUES (:userid,:fname,:fcode,:fcontact,:femail,:fpan,:fadhar,:fimage,:fkyc)");
...
*/	public function updatefarmer_Onboarding($fid,$fname,$contact,$email,$pan,$adhar,$newfilename,$kycFilesSerialized)
	...
	public function setCompany_Onboarding($c_name,$c_pan,$c_reg,$c_gst,$c_adhar,$newfilename,$kycFilesSerialized,$accountId)
	{
		$result = '';
		//  code to fetch serail number and increment by 1//
		...
		$stmt=$this->db->prepare("INSERT INTO `company_onboarding`(user_id,`cm_name`,`cm_code` , `cm_pan`, `cm_reg`, `cm_gst`, `cm_adhar`, `cm_cheque`,`cm_kyc`) VALUES (:userid,:cname,:ccode,:cpan,:creg,:cgst,:cadhar,:ccheque,:ckyc)");
